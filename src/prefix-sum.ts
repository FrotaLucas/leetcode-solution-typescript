...
//SACADA
// A sacada matemática é:

// O slice de menor média sempre tem tamanho 2 ou 3.

// 🧠 Por quê:

// Se um slice maior tiver a menor média, ele obrigatoriamente 
// contém um sub-slice de tamanho 2 ou 3 com a mesma ou menor média.
